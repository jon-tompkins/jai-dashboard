-- =============================================================================
-- COMPLETE PLAID SETUP (FIXED) - Run this entire file in Supabase SQL Editor
...
DROP POLICY IF EXISTS "Allow all on symbols" ON symbols;
